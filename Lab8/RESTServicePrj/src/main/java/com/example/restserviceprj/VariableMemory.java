...
public class VariableMemory {
    ...
    // This Get will run on all the visit to all names
    @Path("list/variables")
    @GET
    @Produces("text/plain")
    public Response getFromMemory() {
        System.out.println("GET request by visiting with /variable-memory/list/variables");
        String output = "";
